...
class TestAwsMetricAttributeGenerator(TestCase):
    ...
    def test_sdk_client_span_with_remote_resource_attributes(self):
        ...
        self.span_mock.kind = SpanKind.CLIENT
        self._mock_attribute(
            [AWS_LAMBDA_FUNCTION_NAME, SpanAttributes.RPC_SERVICE, SpanAttributes.RPC_METHOD],
            ["test_downstream_lambda1", "Lambda", "Invoke"],
            keys,
            values,
        )
        ...
        self._mock_attribute(
            [AWS_LAMBDA_FUNCTION_NAME, SpanAttributes.RPC_SERVICE, SpanAttributes.RPC_METHOD], [None, None, None]
        )
        ...
        self._mock_attribute(
            [AWS_LAMBDA_FUNCTION_NAME, SpanAttributes.RPC_SERVICE, SpanAttributes.RPC_METHOD],
            ["testLambdaFunction", "Lambda", "Invoke"],
            keys,
            values,
        )
        dependency_attributes = _GENERATOR.generate_metric_attributes_dict_from_span(self.span_mock, self.resource).get(
        ...
        self._mock_attribute(
            [AWS_LAMBDA_FUNCTION_NAME, AWS_LAMBDA_FUNCTION_ARN, SpanAttributes.RPC_SERVICE, SpanAttributes.RPC_METHOD],
            ["testLambdaFunction", lambda_arn, "Lambda", "GetFunction"],
            keys,
            values,
        )
    ...
    def _validate_remote_resource_attributes(
        self, expected_type: str, expected_identifier: str, expected_cfn_primary_id: Optional[str] = None
    ) -> None:
        # If no CloudFormation primary identifier is provided, it should default to the resource identifier
